...
The ufo branch of this project provides an additional demo that takes the war artifact, builds a Docker image and deploys it to ECS.  For details please check out that branch: [ufo](https://github.com/sureshreddy143/sample-htd-project.git). For more details on ufo check out the [official ufo docs](http://ufoships.com/).
